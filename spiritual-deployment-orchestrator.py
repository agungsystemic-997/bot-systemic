...
SpiritualStaticBotRegistry = framework.SpiritualStaticBotRegistry
SpiritualBotCategory = framework.SpiritualBotCategory
SpiritualStaticBotApp = framework.SpiritualStaticBotApp
SpiritualAdvancedBotRegistry = registry_module.SpiritualAdvancedBotRegistry  # Correct class name
...
class SpiritualDeploymentOrchestrator:
    ...
    async def initialize_systems(self) -> Dict[str, bool]:
        ...
        try:
            ...
            self.bot_registry = SpiritualAdvancedBotRegistry()
            # Note: SpiritualAdvancedBotRegistry doesn't have an initialize method
